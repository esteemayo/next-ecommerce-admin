  ...
  return (
    <aside className={`${show ? 'left-0' : '-left-full'} text-gray-500 p-4 fixed w-full bg-bgGray h-full md:static md:w-auto z-10 transition-all`}>
      ...
      <nav className='flex flex-col gap-2'>
        <Link onClick={onClose} href='/' passHref className={pathname === '/' ? activeLink : inactiveLink}>
        ...
        <Link onClick={onClose} href='/products' passHref className={pathname.includes('/products') ? activeLink : inactiveLink}>
        ...
        <Link onClick={onClose} href='/categories' passHref className={pathname.includes('/categories') ? activeLink : inactiveLink}>
        ...
        <Link onClick={onClose} href='/orders' passHref className={pathname.includes('/orders') ? activeLink : inactiveLink}>
        ...
        <Link onClick={onClose} href='/settings' passHref className={pathname.includes('/settings') ? activeLink : inactiveLink}>
        ...
        <button type='button' onClick={handleLogout} className={inactiveLink}>
