      ...
      <div>
        ...
        <div className='mb-2'>
          {!!images.length && images.map((item, index) => {
            <div key={index} className='inline-block h-24'>
              <Image src={item} alt='' />
            </div>
          })}
          <label htmlFor='photos' className='inline-block w-24 h-24 cursor-pointer flex items-center justify-center gap-1 text-sm text-gray-500 rounded-lg bg-gray-200'>
