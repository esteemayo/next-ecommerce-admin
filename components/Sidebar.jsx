...
const Sidebar = ({ show }) => {
  ...
  return (
    <aside className={`${show ? 'left-0' : '-left-full'}text-gray-500 p-4 fixed w-full bg-bgGray h-full`}>
      ...
      <nav className='flex flex-col gap-2'>
        ...
        <Link href='/products' passHref className={pathname.includes('/products') ? activeLink : inactiveLink}>
