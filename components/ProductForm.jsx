    ...
    <form onSubmit={handleSubmit}>
      ...
      <div>
        ...
        <div className='mb-2 flex flex-wrap gap-1'>
          ...
          <label htmlFor='photos' className='w-24 h-24 cursor-pointer flex items-center justify-center gap-1 text-sm text-gray-500 rounded-sm bg-white shadow-sm border border-gray-200'>
